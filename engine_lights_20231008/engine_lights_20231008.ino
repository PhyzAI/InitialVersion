...
#define LED_COUNT_RSIDE 130
#define LED_COUNT_RFRONT 28
#define LED_COUNT_LSIDE 130
#define LED_COUNT_LFRONT 38
#define LED_COUNT_REAR    6
...
void colorSwipeNormal(int color_val, int wait) {
  ...
  for(int i=0; i<loop_count_limit; i++) { // For each pixel in strip...
    strip_rside.setPixelColor(i%strip_rside.numPixels(), strip_rside.Color(  0, 255, color_val));         //  Set pixel's color (in RAM)
  }
  ...
  for(int i=0; i<loop_count_limit; i++) { // For each pixel in strip...
    strip_lside.setPixelColor(i%loop_count_limit, strip_lside.Color(  0, 0, 0));         //  Set pixel's color (in RAM)
    for (int j=i; j<i+5; j++) {
 ...
 // for(int i=0; i<loop_count_limit; i++) { // For each pixel in strip...
  ...
  for(int i=0; i<loop_count_limit; i++) { // For each pixel in strip...
    strip_lfront.setPixelColor(i%strip_lfront.numPixels(), strip_lfront.Color(  0, 255, color_val));         //  Set pixel's color (in RAM)
  }
