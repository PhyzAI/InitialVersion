...
#define HEADLIGHTS    5
#define BLINKER_LEFT  6
#define BLINKER_RIGHT 7
...
// PWM frequency to sound mapping
  if ((duration_vertical > VERTICAL_HIGH_THRESHOLD) && (duration_horizontal < HORIZONTAL_LOW_THRESHOLD)) { play_song = SongList::NoSong;}
